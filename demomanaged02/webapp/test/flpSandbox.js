		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo Fiori App 02",
									"targetURL": "#nsdemomanaged02demomanaged02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsdemomanaged02demomanaged02-display": {
								"semanticObject": "nsdemomanaged02demomanaged02",
								"action": "display",
								"description": "Demo Fiori App 02",
								"title": "Demo Fiori App 02",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.demomanaged02.demomanaged02",
									"url": sap.ui.require.toUrl("ns/demomanaged02/demomanaged02")
								}
							}
						}
					}
